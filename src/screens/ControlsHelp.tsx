    ...
    <>
      ...
      <nav className="hidden md:flex fixed left-0 top-0 h-full flex-col pt-16 docked left-0 w-64 rounded-none border-r border-outline-variant bg-surface-container-low dark:bg-surface-container-low">
        ...
        <div className="flex-1 flex flex-col gap-2 w-full">
          ...
          <a
            className="flex items-center gap-4 bg-primary text-on-primary font-bold px-4 py-3 rounded-none"
            aria-current="page"
          >
            <Circle className="fill-current" data-icon="memory" aria-hidden={true} focusable="false" />
