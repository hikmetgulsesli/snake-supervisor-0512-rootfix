...
export function GameBoard({ actions }: GameBoardProps) {
  return (
    <>
      ...
      <button className="w-full h-target-min border border-outline hover:border-primary text-on-surface hover:text-primary transition-colors font-status-label text-status-label flex items-center justify-center gap-2" type="button" data-action-id="reboot-session-1" onClick={actions?.["reboot-session-1"]}>
      <Circle aria-hidden={true} focusable="false" />
                       REBOOT SESSION
                   </button>
      </div>
      ...
      {/* Mobile Menu Icon */}
      <button className="md:hidden text-on-surface-variant p-2 -ml-2" type="button" data-action-id="button-2-2" onClick={actions?.["button-2-2"]}>
      ...
      <button className="p-2 hover:bg-surface-container transition-colors duration-200 rounded-DEFAULT" type="button" data-action-id="button-3-3" onClick={actions?.["button-3-3"]}>
      <Circle aria-hidden={true} focusable="false" />
      </button>
      <button className="p-2 hover:bg-surface-container transition-colors duration-200 rounded-DEFAULT" type="button" data-action-id="button-4-4" onClick={actions?.["button-4-4"]}>
      ...
      <p className="font-stat-value text-stat-value text-primary">02450</p>
      </div>
      {/* Status Chip: Length */}
      ...
      <p className="font-stat-value text-stat-value text-secondary">042</p>
      </div>
      {/* Status Chip: Latency */}
      ...
      <p className="font-stat-value text-stat-value text-error">12ms</p>
      </div>
      {/* Spacer */}
      ...
      <div className="hidden absolute inset-0 bg-background/80 backdrop-blur-md flex flex-col items-center justify-center z-10">
      <h2 className="font-headline-lg text-headline-lg text-primary tracking-widest mb-4">SYSTEM_PAUSED</h2>
      <button className="bg-primary text-on-primary border border-primary hover:bg-surface-tint font-status-label text-status-label px-8 h-target-min transition-colors shadow-[0_0_15px_rgba(75,226,119,0.3)]" type="button" data-action-id="resume-execution-5" onClick={actions?.["resume-execution-5"]}>
                                  RESUME_EXECUTION
                              </button>
      </div>
      </div>
      ...
      <button className="w-full h-target-min bg-surface border border-outline-variant hover:border-primary active:bg-primary active:text-on-primary flex items-center justify-center transition-colors rounded-sm" type="button" data-action-id="button-6-6" onClick={actions?.["button-6-6"]}>
      <Circle aria-hidden={true} focusable="false" />
      </button>
      </div>
      <div className="col-start-1 row-start-2">
      <button className="w-full h-target-min bg-surface border border-outline-variant hover:border-primary active:bg-primary active:text-on-primary flex items-center justify-center transition-colors rounded-sm" type="button" data-action-id="button-7-7" onClick={actions?.["button-7-7"]}>
      <Circle aria-hidden={true} focusable="false" />
      </button>
      </div>
      <div className="col-start-2 row-start-2">
      <button className="w-full h-target-min bg-surface border border-outline-variant hover:border-primary active:bg-primary active:text-on-primary flex items-center justify-center transition-colors rounded-sm" type="button" data-action-id="button-8-8" onClick={actions?.["button-8-8"]}>
      <Circle aria-hidden={true} focusable="false" />
      </button>
      </div>
      <div className="col-start-3 row-start-2">
      <button className="w-full h-target-min bg-surface border border-outline-variant hover:border-primary active:bg-primary active:text-on-primary flex items-center justify-center transition-colors rounded-sm" type="button" data-action-id="button-9-9" onClick={actions?.["button-9-9"]}>
      <Circle aria-hidden={true} focusable="false" />
      </button>
      </div>
      </div>
      ...
      <button className="h-target-min px-6 border border-outline-variant bg-surface hover:border-primary text-on-surface hover:text-primary transition-colors font-status-label text-status-label flex items-center gap-2 rounded-sm focus:ring-2 focus:ring-primary focus:outline-none focus:border-transparent" type="button" data-action-id="pause-10" onClick={actions?.["pause-10"]}>
